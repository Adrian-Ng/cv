...
\begin{document}
	...
	{
		{
			In this position I gained my first experience with writing \textit{SQL} code in SQL Server Management Studio. Using rudimentary \textit{DML} \& \textit{DDL}, I was able to query the ticketing and customer databases to extract data for warehousing/analysis/segmentation. 
		}
	}

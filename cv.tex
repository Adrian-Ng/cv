...
%		\textbf{} & Website: \href{https://adrian.ng}{https://adrian.ng} \\
	...
	{	
		...
		\newline 
		Java artifacts were exported and ran on Hadoop clusters (both single node and distributed). Input/Output data were stored in HDFS and accessed via \texttt{hadoop fs} syntax.
		\newline 
...
%	}		
	...
	{
		This project involved the creation of a number of automated processes to merge GDPR preference data with the analytical database. To accomplish this, SQL DML such as \texttt{merge} were utilised.
	}

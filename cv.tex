...
\begin{document}
	...
	\quad Prior to postgraduate study, my expertise was in \textit{SQL development}, mainly writing segmentation processes. My recent role at Manchester City FC was a brief but beneficial learning experience: 
	
	% DON'T SAY THIS
%	that I am no analyst and that I am uninterested in generating insights or making business recommendations. 
	
	Rather, I thrive when writing code, building things, and solving technical problems. 
	...
	{
		Built a number of automated segmentation process using SQL stored procedures for team members to utilise. Recipient data were imported via \texttt{BULK INSERT}, stored in database tables and indexed (clustered). Segmentation data was output and linked to HTML content to be broadcast to recipients.
	}
	\resumeItem{Debugging}{}
	{
		Try/Catch blocks
		Logging
		Error printing (if erroring while attempted to execute dynamic sql, print SQL)
	}

...
\noindent
\textbf{TUI Redesign:}
I collaborated with the TUI client to integrate a new design of their large deployment broadcasts (5M+ recipients) for \textit{Thomson} and \textit{First Choice} brands. \texttt{TCL} scripts were developed to dynamically merge fields into the \texttt{HTML} body and, where possible, efficienices were gained by moving expensive operations upstream. Over the course of this three-month project, I gained recognition with the client and was awarded for my efforts.

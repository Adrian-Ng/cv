...
{
	I collaborated closely with the TUI client during a three-month project to integrate and QA new \texttt{HTML} content, replacing the existing solution for \textit{Thomson} and \textit{First Choice} mailings.	\texttt{TCL} scripts were used to query \texttt{SQL} data and merge \texttt{HTML} dynamically. Efforts on this project were recognised by client.
	\newline
}

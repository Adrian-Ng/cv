...
{
	I wrote number of \textit{MapReduce} applications in Java including extracting the communications network from the \textit{Enron Corpus}, a large dataset of emails, or aggregation of Twitter data.
	\newline
